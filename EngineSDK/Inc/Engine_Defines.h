...
namespace Engine
{
	...
	enum CHANNELID { SOUND_EFFECT, SOUND_HOVERBOARD, SOUND_HOVERBOARD_DASH, SOUND_PLAYER, SOUND_MONSTER, SOUND_MONSTER05, SOUND_BOSS, SOUND_BGM, SOUND_SUBBGM, SOUND_UI, MAXCHANNEL };
