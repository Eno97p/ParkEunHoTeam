...
{
public:
	enum TRIGGER_TYPE {TRIG_TUTORIAL_BOSSENCOUNTER, TRIG_JUGGLAS_SPAWNSECONDROOM, TRIG_JUGGLAS_SPAWNTHIRDROOM, TRIG_VIEWCHANGE_TTOS, TRIG_VIEWCHANGE_STOT, TRIG_ASCEND_ELEVATOR, TRIG_DESCEND_ELEVATOR, TRIG_END};
private:
